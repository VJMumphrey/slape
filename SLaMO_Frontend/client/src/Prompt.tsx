...
export default function Prompt() {
  ...
  const promptTypes = [{name: "Simple", type: "simple"}, {name: "Chain of Thought", type: "cot"}, {name: "Tree of Thought", type: "tot"}, {name: "Graph of Thought", type: "got"}, {name: "Thinking Hats", type: "thinkinghats"}];

  function dropDownButton() {
    return (
    <select value={PromptMode} onChange={(event) =>{setPromptMode(event.target.value);}}>
      {promptTypes.map(
        (type) => {
          return (
